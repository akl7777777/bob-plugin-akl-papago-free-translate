...
def update_appcast(message):
    ...
    release_file = Path(f"release/bob-plugin-akl-papago-free-translate.bobplugin")
    ...
    version_info = {
        ...
        "desc": message,
        "sha256": file_hash,
        "url": f"https://github.com/akl7777777/bob-plugin-akl-papago-free-translate/releases/download/v{version}/bob-plugin-akl-papago-free-translate_v{version}.bobplugin",
        "minBobVersion": "0.5.0"
    }
    ...
    if appcast_file.is_file():
        ...
        appcast = dict(identifier="com.akl.bob-plugin-akl-papago-free-translate", versions=[])
